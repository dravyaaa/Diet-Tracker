...
def main():
    # Load diet data from file
    diet_data_file = "diet_data.json"
    user_data_file = "user_data.json"
    functions.load_diet_data(diet_data_file)
    functions.load_user_data(User_Data_file)
    ...
    while True:
        ...
        if choice == 1:
            ...
            functions.save_diet_data(diet_data_file)
            functions.save_user_data(user_data_file)
        elif choice == 2:
